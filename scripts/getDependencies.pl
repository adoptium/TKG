...
my %base = (
	...
	jtregtip => {
		url => 'https://ci.adoptium.net/job/dependency_pipeline/lastSuccessfulBuild/artifact/jtreg/jtregtip.tar.gz',
		fname => 'jtregtip.tar.gz',
		shaurl => 'https://ci.adoptium.net/job/dependency_pipeline/lastSuccessfulBuild/artifact/jtreg/jtregtip.tar.gz.sha256sum.txt',
		shafn => 'jtregtip.tar.gz.sha256sum.txt',
		shaalg => '256'
	},
	jython => {
